...
from ByrdLab.centraliedAlgorithm import CSGD, CSGD_under_DPA, CSGD_compute_hetero, CMomentum_compute_hetero
...
# initilize optimizer
env = CMomentum_compute_hetero(aggregation=aggregation, honest_nodes=honest_nodes, byzantine_nodes=byzantine_nodes, attack=attack, step_agg = step_agg,
