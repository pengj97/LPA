...
from ByrdLab.centraliedAlgorithm import CSGD, CSGD_under_DPA, CSGD_under_DPA_compute_bound, CMomentum_under_DPA_compute_bound
...
if 'label' in attack_name:
    env = CMomentum_under_DPA_compute_bound(aggregation=aggregation, honest_nodes=honest_nodes, byzantine_nodes=byzantine_nodes, attack=attack, step_agg = step_agg,
